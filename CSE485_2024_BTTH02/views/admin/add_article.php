    ...
    <main class="container mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-sm">
                ...
                <form action="../../controllers/controller_add_article.php" method="post">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="bhat" >
                    </div>
                    
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="sumary_id">Mã thể loại</span>
                        
                        <input type="number" class="form-control" name="theloai">
                    </div>
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="number" class="form-control" name="tacgia">
                    </div>
                    ...
                    <div class="form-group  float-end ">
                        <input type="submit"  value="Thêm" class="btn btn-success " href="article.php">
